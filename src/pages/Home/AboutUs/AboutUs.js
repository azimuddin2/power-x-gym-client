        ...
        <section className='max-w-screen-lg lg:mx-auto mx-5 my-12 lg:my-20'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20'>
                ...
                <div className='lg:mt-20'>
                    ...
                    <p className='mt-4 text-secondary text-sm leading-6 lg:w-4/5'>A gym is a large room, usually containing special equipment, where people go to do physical exercise and get fit. The gym has exercise bikes and running machines. While some guests play golf, others work out in the hotel gym.</p>
                    <Link to='/'
