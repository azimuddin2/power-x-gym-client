        ...
        <section className='max-w-screen-lg lg:mx-auto mx-5 my-12 lg:my-20'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mt-10'>
                <div className='relative'>
                    <img src={femaleTrainingImg} alt="" style={{ height: '400px' }} />
                    <Link to='/'
                        className="absolute bottom-12 bg-primary text-secondary mt-8 font-semibold uppercase inline-flex justify-center items-center py-4 px-12 text-lg text-center rounded-none hover:bg-yellow-200 font-family">
                ...
                <div className='relative'>
                    <img src={maleTrainingImg} alt="" style={{ height: '400px' }} />
                    <Link to='/'
                        className="absolute bottom-12 bg-primary text-secondary mt-8 font-semibold uppercase inline-flex justify-center items-center py-4 px-12 text-lg text-center rounded-none hover:bg-yellow-200 font-family">
