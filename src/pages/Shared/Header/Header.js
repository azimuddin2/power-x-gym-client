    ...
    return (
        <div className='fixed z-10 w-full'>
            <Navbar className='lg:bg-opacity-0 max-w-screen-xl lg:mx-auto'>
                ...
                <Navbar.Toggle />
                <Navbar.Collapse className='lg:bg-opacity-0 font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-100 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
